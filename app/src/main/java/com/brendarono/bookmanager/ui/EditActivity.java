...
public class EditActivity extends AppCompatActivity {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        Log.i("bookmanager", book.getAuthor());
            ...
            public void onClick(View v) {
                ...
                if (validate(fiedls)) {
                    ...
                    Book book_edited = new Book(
                            ...
                            eprice_et.getText().toString(),
                            eyear_et.getText().toString(),
                    ...
                    Toast.makeText(EditActivity.this, "Empty fields!", Toast.LENGTH_SHORT).show();
                }
            }
        });
    }
